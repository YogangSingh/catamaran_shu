#!/usr/bin/env python
'''
Improves the straightline controller with a full PID controller, dynamic replanning, and safety mechanisms.
'''
...
class StraightLineBehaviorController:
    ...
    def odom_callback(self, odom_msg):
        ...
        if self.current_path is None:
            ...
            target_position = (start[0] + 0.000215, start[1] + 0.0002)  
            self.current_path = self.generate_straight_line_path(start, target_position, num_points=100)
    ...
    def publish_generated_path(self):
        ...
        for point in self.current_path.poses:
...
def main():
    try:
        ...
        print("Straightline behaviour node is running.")
